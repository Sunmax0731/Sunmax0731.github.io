(() => {
    ...
    if (!e2) {
      ...
      e2 = i2 ? (t3, e3) => i2(t3, e3, r2) : (t3, e3) => {
        for (; mt(e3) && 4 != e3.h; ) {
          ...
          s2 && s2(e3, t3, i3) || (i3 = (s2 = e3).l, yt(s2), s2.ia ? s2 = void 0 : (o2 = s2.g.g - i3, s2.g.g = i3, s2 = pt(s2.g, o2)), i3 = t3, s2 && (de || (de = /* @__PURE__ */ Symbol()), (o2 = i3[de]) ? o2.push(s2) : i3[de] = [s2]));
        }
        n2 === tr || n2 === er || n2.j || (t3[fe || (fe = /* @__PURE__ */ Symbol())] = n2);
      }, t2[qn] = e2;
    }
    return e2;
  }
  ...
  var GifPlayer = class {
    ...
    async load(file) {
      ...
      if (!("ImageDecoder" in window)) {
        console.warn("[GIF] ImageDecoder \u975E\u5BFE\u5FDC \u2014 \u9759\u6B62\u753B\u30D5\u30A9\u30FC\u30EB\u30D0\u30C3\u30AF");
        const bitmap = await createImageBitmap(file);
        this.frames = [{ bitmap, duration: 100 }];
      ...
      for (let i2 = 0; i2 < count; i2++) {
        ...
        if (i2 === 0) {
          cw.width = image.displayWidth;
          cw.height = image.displayHeight;
        }
        cctx.drawImage(image, 0, 0);
        const bitmap = await createImageBitmap(cw);
        const durationMs = Math.max((image.duration || 1e5) / 1e3, 10);
        this.frames.push({ bitmap, duration: durationMs });
      ...
      this.ready = true;
      decoder.close();
      console.log(`[GIF] \u8AAD\u307F\u8FBC\u307F\u5B8C\u4E86: ${this.width}x${this.height}, ${count}\u30D5\u30EC\u30FC\u30E0, ${Math.round(totalDuration)}ms`);
    }
    getCurrentFrame() {
      if (!this.ready || this.frames.length === 0) return null;
      if (this.frames.length === 1) return this.frames[0].bitmap;
      const elapsed = performance.now() - this.startTime;
      let t2 = elapsed % this.totalDuration;
      for (let i2 = 0; i2 < this.frames.length; i2++) {
        t2 -= this.frames[i2].duration;
        if (t2 <= 0) return this.frames[i2].bitmap;
      }
      return this.frames[this.frames.length - 1].bitmap;
    }
    clear() {
      this.frames.forEach((f2) => f2.bitmap.close());
      this.frames = [];
      this.totalDuration = 0;
      this.ready = false;
    }
  ...
  function getRequiredContext(canvas, kind, options) {
    const context = canvas.getContext(kind, options);
    if (!context) {
      throw new Error(`Canvas context \u306E\u53D6\u5F97\u306B\u5931\u6557\u3057\u307E\u3057\u305F: #${canvas.id}`);
    }
    return context;
  }
  ...
  function isTimeoutError(error) {
    return getErrorMessage(error).includes("\u30BF\u30A4\u30E0\u30A2\u30A6\u30C8");
  }
  function isChromium() {
  ...
  function getCameraErrorMessage(error) {
    ...
    switch (name) {
      case "NotAllowedError":
        return "\u30AB\u30E1\u30E9\u5229\u7528\u304C\u62D2\u5426\u3055\u308C\u307E\u3057\u305F\u3002\u30D6\u30E9\u30A6\u30B6\u3068 Windows \u306E\u4E21\u65B9\u3067\u8A31\u53EF\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
      case "NotFoundError":
        return "\u5229\u7528\u53EF\u80FD\u306A\u30AB\u30E1\u30E9\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3002";
      case "NotReadableError":
        return "\u30AB\u30E1\u30E9\u306B\u63A5\u7D9A\u3067\u304D\u307E\u305B\u3093\u3002\u30D6\u30E9\u30A6\u30B6\u307E\u305F\u306F OS \u5074\u3067\u30C7\u30D0\u30A4\u30B9\u304C\u5FDC\u7B54\u3057\u3066\u3044\u306A\u3044\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059\u3002";
      case "OverconstrainedError":
        return "\u30AB\u30E1\u30E9\u6761\u4EF6\u304C\u53B3\u3057\u3059\u304E\u307E\u3059\u3002\u65E2\u5B9A\u306E\u30AB\u30E1\u30E9\u3067\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
      case "AbortError":
        return "\u30AB\u30E1\u30E9\u521D\u671F\u5316\u304C\u4E2D\u65AD\u3055\u308C\u307E\u3057\u305F\u3002";
      default:
        return getErrorMessage(error);
    }
  }
  function showMfWorkaround() {
    const existing = document.getElementById("mf-workaround");
    if (existing) return;
    const div = document.createElement("div");
    div.id = "mf-workaround";
    div.style.cssText = "background:#2a1a1a;border:1px solid #f88;border-radius:8px;padding:14px;margin-top:12px;font-size:0.82rem;color:#fcc;line-height:1.7;";
    div.innerHTML = `
    <strong style="color:#f88">\u30AB\u30E1\u30E9\u63A5\u7D9A\u304C\u30BF\u30A4\u30E0\u30A2\u30A6\u30C8\u3057\u307E\u3057\u305F</strong><br>
    Chrome \u306E MediaFoundation \u30D0\u30C3\u30AF\u30A8\u30F3\u30C9\u304C\u5FDC\u7B54\u3057\u306A\u3044\u5834\u5408\u304C\u3042\u308A\u307E\u3059\u3002<br>
    \u4EE5\u4E0B\u306E\u624B\u9806\u3067\u89E3\u6C7A\u3067\u304D\u307E\u3059:
    <ol style="margin:8px 0 0 18px;padding:0">
      <li>Chrome \u306E\u30A2\u30C9\u30EC\u30B9\u30D0\u30FC\u306B <code style="background:#1a1a2e;padding:2px 6px;border-radius:3px;user-select:all">chrome://flags/#media-foundation-video-capture</code> \u3092\u5165\u529B</li>
      <li><strong>Media Foundation Video Capture</strong> \u3092 <strong>Disabled</strong> \u306B\u5909\u66F4</li>
      <li>Chrome \u3092\u518D\u8D77\u52D5</li>
    </ol>
  `;
  ...
  var video = getRequiredElement("video");
  var outputCanvas = getRequiredElement("output");
  var maskCanvas = getRequiredElement("mask-canvas");
  var ctx = getRequiredContext(outputCanvas, "2d");
  var maskCtx = getRequiredContext(maskCanvas, "2d", { willReadFrequently: true });
  var statusEl = getRequiredElement("status");
  var faceGif = new GifPlayer();
  var bgGif = new GifPlayer();
  var initBtn = getRequiredElement("init-btn");
  var cameraSelect = getRequiredElement("camera-select");
  var cameraRefreshBtn = getRequiredElement("camera-refresh-btn");
  var faceOverlayEnable = getRequiredElement("face-overlay-enable");
  var bgEnable = getRequiredElement("bg-enable");
  var faceScaleInput = getRequiredElement("face-scale");
  var faceScaleVal = getRequiredElement("face-scale-val");
  var faceOffsetInput = getRequiredElement("face-offset");
  var faceOffsetVal = getRequiredElement("face-offset-val");
  var faceRotateEnable = getRequiredElement("face-rotate-enable");
  var segThreshInput = getRequiredElement("seg-thresh");
  var segThreshVal = getRequiredElement("seg-thresh-val");
  var debugFaceEnable = getRequiredElement("debug-face-enable");
  var debugPoseEnable = getRequiredElement("debug-pose-enable");
  var debugHandEnable = getRequiredElement("debug-hand-enable");
  var debugPointSizeInput = getRequiredElement("debug-point-size");
  var debugPointSizeVal = getRequiredElement("debug-point-size-val");
  var debugLineWidthInput = getRequiredElement("debug-line-width");
  var debugLineWidthVal = getRequiredElement("debug-line-width-val");
  var debugStatus = getRequiredElement("debug-status");
  debugPointSizeInput.addEventListener("input", () => {
    debugPointSizeVal.textContent = debugPointSizeInput.value;
  });
  debugLineWidthInput.addEventListener("input", () => {
    debugLineWidthVal.textContent = debugLineWidthInput.value;
  });
  ...
  async function getCameraPermissionState() {
    if (!navigator.permissions || !navigator.permissions.query) {
      console.warn("[Camera] Permissions API \u306F\u672A\u5BFE\u5FDC\u3067\u3059\u3002\u6A29\u9650\u72B6\u614B\u306E\u4E8B\u524D\u78BA\u8A8D\u3092\u30B9\u30AD\u30C3\u30D7\u3057\u307E\u3059");
      return null;
    }
    try {
      ...
      console.log("[Camera] \u8A31\u53EF\u72B6\u614B:", permission.state);
      return permission.state;
    } catch (error) {
      console.warn("[Camera] Permissions API \u306E\u78BA\u8A8D\u306B\u5931\u6557\u3057\u307E\u3057\u305F:", error);
      return null;
    }
  }
  ...
  function waitForTimeout(ms2, label) {
    return new Promise((_2, reject) => {
      window.setTimeout(() => {
        reject(new Error(`${label} \u304C\u30BF\u30A4\u30E0\u30A2\u30A6\u30C8\u3057\u307E\u3057\u305F (${ms2}ms)`));
      }, ms2);
    });
  }
  async function enumerateDevicesWithTimeout() {
    return Promise.race([
      navigator.mediaDevices.enumerateDevices(),
      waitForTimeout(DEVICE_ENUMERATION_TIMEOUT_MS, "\u30C7\u30D0\u30A4\u30B9\u5217\u6319")
    ]);
  }
  ...
  function setCameraSelectFromCurrentStream() {
    ...
    cameraSelect.innerHTML = "";
    const option = document.createElement("option");
    option.value = settings.deviceId ?? "";
    option.textContent = track.label || "\u73FE\u5728\u306E\u30AB\u30E1\u30E9";
    cameraSelect.appendChild(option);
  ...
  async function createTaskWithDelegateFallback(label, createTask) {
    try {
      return await createTask("GPU");
    } catch (gpuError) {
      console.warn(`[Init] ${label} \u306E GPU \u521D\u671F\u5316\u306B\u5931\u6557\u3057\u307E\u3057\u305F\u3002CPU \u306B\u30D5\u30A9\u30FC\u30EB\u30D0\u30C3\u30AF\u3057\u307E\u3059`, gpuError);
      statusEl.textContent = `${label} \u3092 CPU \u3067\u521D\u671F\u5316\u4E2D...`;
      return createTask("CPU");
    }
  }
  async function populateCameraList() {
    const prevId = cameraSelect.value;
    if (!navigator.mediaDevices || !navigator.mediaDevices.enumerateDevices) {
      statusEl.textContent = "\u30A8\u30E9\u30FC: mediaDevices API \u304C\u5229\u7528\u3067\u304D\u307E\u305B\u3093";
      return;
    }
    try {
      ...
      videoDevices.forEach((device, index) => {
        ...
        option.textContent = device.label || `\u30AB\u30E1\u30E9 ${index + 1} (ID: ${device.deviceId.slice(0, 8)}...)`;
        if (device.deviceId === prevId) {
      ...
      if (getErrorMessage(error).includes("\u30BF\u30A4\u30E0\u30A2\u30A6\u30C8")) {
        if (currentStream) {
          setCameraSelectFromCurrentStream();
        } else {
          setCameraSelectFallback("\u65E2\u5B9A\u306E\u30AB\u30E1\u30E9\u3092\u4F7F\u7528");
        }
        statusEl.textContent = "\u30C7\u30D0\u30A4\u30B9\u5217\u6319\u304C\u6B62\u307E\u3063\u3066\u3044\u307E\u3059\u3002\u65E2\u5B9A\u306E\u30AB\u30E1\u30E9\u3067\u8D77\u52D5\u3067\u304D\u307E\u3059\u3002";
        return;
      }
      statusEl.textContent = `\u30A8\u30E9\u30FC: ${getErrorMessage(error)}`;
    }
  }
  var cameraVisibleCheck = getRequiredElement("camera-visible");
  var sidebarToggle = getRequiredElement("sidebar-toggle");
  var sidebar = getRequiredElement("sidebar");
  ...
  cameraVisibleCheck.addEventListener("change", () => {
    cameraVisible = cameraVisibleCheck.checked;
  });
  ...
  function initDropZone({
    ...
    async function applyFile(file) {
      console.log(`[GIF] \u30D5\u30A1\u30A4\u30EB\u8AAD\u307F\u8FBC\u307F\u958B\u59CB: ${file.name}`);
      ...
      try {
        await gifPlayer.load(file);
        console.log(`[GIF] ${file.name} \u8AAD\u307F\u8FBC\u307F\u6210\u529F`);
      } catch (err) {
        console.error("[GIF] \u30C7\u30B3\u30FC\u30C9\u5931\u6557:", err);
      }
    }
  }
  initDropZone({
    zone: getRequiredElement("face-drop"),
    fileInput: getRequiredElement("face-file"),
    previewEl: getRequiredElement("face-dz-preview"),
    filenameEl: getRequiredElement("face-filename"),
    clearBtn: getRequiredElement("face-clear"),
    gifPlayer: faceGif
  });
  initDropZone({
    zone: getRequiredElement("bg-drop"),
    fileInput: getRequiredElement("bg-file"),
    previewEl: getRequiredElement("bg-dz-preview"),
    filenameEl: getRequiredElement("bg-filename"),
    clearBtn: getRequiredElement("bg-clear"),
    gifPlayer: bgGif
  });
  faceScaleInput.addEventListener("input", () => {
    faceScaleVal.textContent = faceScaleInput.value;
  });
  faceOffsetInput.addEventListener("input", () => {
    faceOffsetVal.textContent = faceOffsetInput.value;
  });
  segThreshInput.addEventListener("input", () => {
    segThreshVal.textContent = segThreshInput.value;
  });
  initBtn.addEventListener("click", async () => {
    console.log("[Init] \u30AB\u30E1\u30E9\u8D77\u52D5\u30DC\u30BF\u30F3 \u30AF\u30EA\u30C3\u30AF");
    initBtn.disabled = true;
    statusEl.textContent = "\u30AB\u30E1\u30E9\u63A5\u7D9A\u4E2D...";
    try {
      if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
        throw new Error("\u30AB\u30E1\u30E9 API \u304C\u5229\u7528\u3067\u304D\u307E\u305B\u3093\u3002localhost \u307E\u305F\u306F HTTPS \u3067\u958B\u3044\u3066\u304F\u3060\u3055\u3044\u3002");
      }
      console.log("[Camera] \u30B5\u30DD\u30FC\u30C8\u5236\u7D04:", navigator.mediaDevices.getSupportedConstraints());
      const deviceId = cameraSelect.value;
      console.log("[Init] \u9078\u629E\u30C7\u30D0\u30A4\u30B9ID:", deviceId || "(\u672A\u9078\u629E)");
      ...
      await video.play();
      const trackLabel = stream.getVideoTracks()[0]?.label ?? "\u4E0D\u660E";
      console.log("[Init] \u30D3\u30C7\u30AA\u518D\u751F\u958B\u59CB:", video.videoWidth, "x", video.videoHeight);
      if (cameraInfoEl) {
        cameraInfoEl.textContent = `${trackLabel} - ${video.videoWidth}x${video.videoHeight}`;
      }
      ...
      statusEl.textContent = "MediaPipe \u8AAD\u307F\u8FBC\u307F\u4E2D...";
      console.log("[Init] FilesetResolver \u958B\u59CB...");
      const vision = await Xo.forVisionTasks("./wasm");
      console.log("[Init] FilesetResolver \u5B8C\u4E86");
      console.log("[Init] FaceLandmarker \u8AAD\u307F\u8FBC\u307F\u4E2D...");
      faceLandmarker = await createTaskWithDelegateFallback(
        "FaceLandmarker",
        (delegate) => yh.createFromOptions(vision, {
          baseOptions: {
      ...
      console.log("[Init] FaceLandmarker \u5B8C\u4E86");
      console.log("[Init] ImageSegmenter \u8AAD\u307F\u8FBC\u307F\u4E2D...");
      imageSegmenter = await createTaskWithDelegateFallback(
        "ImageSegmenter",
        (delegate) => Uh.createFromOptions(vision, {
          baseOptions: {
      ...
      console.log("[Init] ImageSegmenter \u5B8C\u4E86");
      console.log("[Init] PoseLandmarker \u8AAD\u307F\u8FBC\u307F\u4E2D...");
      poseLandmarker = await createTaskWithDelegateFallback(
        "PoseLandmarker",
        (delegate) => hc.createFromOptions(vision, {
          baseOptions: {
      ...
      console.log("[Init] PoseLandmarker \u5B8C\u4E86");
      console.log("[Init] HandLandmarker \u8AAD\u307F\u8FBC\u307F\u4E2D...");
      handLandmarker = await createTaskWithDelegateFallback(
        "HandLandmarker",
        (delegate) => kh.createFromOptions(vision, {
          baseOptions: {
      ...
      console.log("[Init] HandLandmarker \u5B8C\u4E86");
      statusEl.textContent = "\u5B9F\u884C\u4E2D";
      isRunning = true;
      console.log("[Init] \u30EC\u30F3\u30C0\u30FC\u30EB\u30FC\u30D7\u958B\u59CB");
      renderLoop();
      populateCameraList().catch((error) => {
        console.warn("[Camera] \u30AB\u30E1\u30E9\u4E00\u89A7\u306E\u518D\u53D6\u5F97\u306B\u5931\u6557\u3057\u307E\u3057\u305F", error);
      });
    } catch (error) {
      console.error("[Error]", getErrorName(error), getErrorMessage(error), error);
      if (isTimeoutError(error) && isChromium()) {
        statusEl.textContent = "\u30AB\u30E1\u30E9\u63A5\u7D9A\u304C\u30BF\u30A4\u30E0\u30A2\u30A6\u30C8\u3057\u307E\u3057\u305F\uFF08MediaFoundation \u306E\u554F\u984C\u306E\u53EF\u80FD\u6027\uFF09";
        showMfWorkaround();
      } else {
        statusEl.textContent = `\u30A8\u30E9\u30FC: ${getCameraErrorMessage(error)}`;
      }
  ...
  function renderLoop() {
    ...
    if (bgEnable.checked && imageSegmenter) {
      const segResult = imageSegmenter.segmentForVideo(video, now);
      if (segResult.categoryMask) {
        categoryMask = segResult.categoryMask.getAsUint8Array();
        segResult.categoryMask.close();
      }
    }
    let faceData = null;
    let faceLandmarks = [];
    const needFace = (faceOverlayEnable.checked || debugFaceEnable.checked) && faceLandmarker;
    if (needFace) {
      const faceResult = faceLandmarker.detectForVideo(video, now);
      faceLandmarks = faceResult.faceLandmarks;
      if (faceLandmarks.length > 0) {
        faceData = calcFaceTransform(faceLandmarks[0], width, height);
      }
    }
    ...
    const bgFrame = bgGif.getCurrentFrame();
    if (bgEnable.checked && bgFrame && categoryMask) {
      ctx.drawImage(bgFrame, 0, 0, width, height);
      drawMaskedPerson(width, height, categoryMask);
    } else {
      ctx.drawImage(video, 0, 0, width, height);
    }
    const faceFrame = faceGif.getCurrentFrame();
    if (faceOverlayEnable.checked && faceFrame && faceData) {
      drawFaceOverlay(faceData, faceFrame);
    }
    const debugAny = debugFaceEnable.checked || debugPoseEnable.checked || debugHandEnable.checked;
    if (debugFaceEnable.checked) {
      for (const landmarks of faceLandmarks) {
        drawDebugLandmarks(landmarks, width, height, "#00ff88", yh.FACE_LANDMARKS_TESSELATION);
      }
    }
    if (debugPoseEnable.checked && poseLandmarker) {
      const poseResult = poseLandmarker.detectForVideo(video, now);
      for (const landmarks of poseResult.landmarks) {
        drawDebugLandmarks(landmarks, width, height, "#ff6644", POSE_CONNECTIONS);
      }
    }
    if (debugHandEnable.checked && handLandmarker) {
      const handResult = handLandmarker.detectForVideo(video, now);
      for (const landmarks of handResult.landmarks) {
        drawDebugLandmarks(landmarks, width, height, "#44aaff", HAND_CONNECTIONS);
      }
    }
    if (debugAny) {
      const parts = [];
      if (debugFaceEnable.checked) parts.push("Face");
      if (debugPoseEnable.checked) parts.push("Pose");
      if (debugHandEnable.checked) parts.push("Hand");
      debugStatus.textContent = parts.join(" + ") + " \u8868\u793A\u4E2D";
    } else {
      debugStatus.textContent = "";
    }
    syncPopout();
  }
  function calcFaceTransform(landmarks, width, height) {
    if (landmarks.length === 0) {
      return {
        cx: width / 2,
        cy: height / 2,
        faceW: Math.min(width, height) / 3,
        angle: 0
      };
    }
    const xs2 = landmarks.map((point) => point.x * width);
    const ys2 = landmarks.map((point) => point.y * height);
    ...
    return { cx, cy, faceW, angle };
  }
  function drawFaceOverlay({ cx, cy, faceW, angle }, frame) {
    const scale = parseFloat(faceScaleInput.value);
    const yOffset = parseFloat(faceOffsetInput.value);
    const useRotate = faceRotateEnable.checked;
    const imgW = frame.width || 100;
    const imgH = frame.height || 100;
    const scaleRatio = faceW / imgW * scale;
    ctx.save();
  ...
  var popoutCanvas = null;
  var popoutCtx = null;
  var popoutBtn = getRequiredElement("popout-btn");
  popoutBtn.addEventListener("click", () => {
    if (popoutWindow && !popoutWindow.closed) {
      popoutWindow.focus();
      return;
    }
    const w2 = outputCanvas.width || 640;
    const h2 = outputCanvas.height || 480;
    popoutWindow = window.open(
      "",
      "FaceTrackingOutput",
      `width=${w2},height=${h2},menubar=no,toolbar=no,location=no,status=no`
    );
    if (!popoutWindow) {
      console.error("[Popout] \u30DD\u30C3\u30D7\u30A2\u30A6\u30C8\u30A6\u30A3\u30F3\u30C9\u30A6\u3092\u958B\u3051\u307E\u305B\u3093\u3067\u3057\u305F");
      return;
    }
    popoutWindow.document.title = "Face Tracking Output";
    popoutWindow.document.body.style.cssText = "margin:0;padding:0;background:#000;overflow:hidden;display:flex;align-items:center;justify-content:center;height:100vh";
    popoutCanvas = popoutWindow.document.createElement("canvas");
    popoutCanvas.width = w2;
    popoutCanvas.height = h2;
    popoutCanvas.style.cssText = "width:100%;height:100%;object-fit:contain";
    popoutWindow.document.body.appendChild(popoutCanvas);
    popoutCtx = popoutCanvas.getContext("2d");
    popoutWindow.addEventListener("beforeunload", () => {
      popoutWindow = null;
      popoutCanvas = null;
      popoutCtx = null;
    });
    console.log("[Popout] \u6620\u50CF\u51FA\u529B\u30A6\u30A3\u30F3\u30C9\u30A6\u3092\u958B\u304D\u307E\u3057\u305F");
  });
  function syncPopout() {
    if (!popoutCtx || !popoutCanvas) return;
    if (popoutCanvas.width !== outputCanvas.width || popoutCanvas.height !== outputCanvas.height) {
      popoutCanvas.width = outputCanvas.width;
      popoutCanvas.height = outputCanvas.height;
    }
    popoutCtx.drawImage(outputCanvas, 0, 0);
  }
  var mediaRecorder = null;
  var recordedChunks = [];
  var recBtn = getRequiredElement("rec-btn");
  var recStopBtn = getRequiredElement("rec-stop-btn");
  var recStatus = getRequiredElement("rec-status");
  recBtn.addEventListener("click", () => {
    if (!isRunning) {
      recStatus.textContent = "\u5148\u306B\u30AB\u30E1\u30E9\u3092\u8D77\u52D5\u3057\u3066\u304F\u3060\u3055\u3044";
      return;
    }
    ...
    mediaRecorder.ondataavailable = (e2) => {
      if (e2.data.size > 0) recordedChunks.push(e2.data);
    };
    mediaRecorder.onstop = () => {
      ...
      a2.href = url;
      a2.download = `face-tracking-${Date.now()}.webm`;
      a2.click();
      URL.revokeObjectURL(url);
      recStatus.textContent = "\u4FDD\u5B58\u3057\u307E\u3057\u305F";
    ...
    console.log("[Rec] \u9332\u753B\u958B\u59CB");
  });
  recStopBtn.addEventListener("click", () => {
    if (mediaRecorder && mediaRecorder.state !== "inactive") {
      mediaRecorder.stop();
      console.log("[Rec] \u9332\u753B\u505C\u6B62");
    }
  });
  function drawMaskedPerson(width, height, categoryMask) {
    const threshold = Number.parseInt(segThreshInput.value, 10);
    maskCtx.drawImage(video, 0, 0, width, height);
    const imageData = maskCtx.getImageData(0, 0, width, height);
    const pixels = imageData.data;
    for (let index = 0; index < categoryMask.length; index += 1) {
      const isPerson = categoryMask[index] <= threshold;
      pixels[index * 4 + 3] = isPerson ? 255 : 0;
    }
    maskCtx.putImageData(imageData, 0, 0);
    ctx.drawImage(maskCanvas, 0, 0);
  }
  function drawDebugLandmarks(landmarks, width, height, color, connections) {
    const pointSize = parseFloat(debugPointSizeInput.value);
    const lineWidth = parseFloat(debugLineWidthInput.value);
    if (connections && connections.length > 0) {
      ...
      for (const c2 of connections) {
        const a2 = landmarks[c2.start];
        const b2 = landmarks[c2.end];
        if (!a2 || !b2) continue;
        ctx.moveTo(a2.x * width, a2.y * height);
        ctx.lineTo(b2.x * width, b2.y * height);
      }
      ctx.stroke();
      ctx.restore();
    }
    ...
    for (const p2 of landmarks) {
      ctx.beginPath();
      ctx.arc(p2.x * width, p2.y * height, pointSize, 0, Math.PI * 2);
      ctx.fill();
    }
    ctx.restore();
  }
